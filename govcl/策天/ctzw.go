...
func (f *TMainForm) OnFormCreateDefault(y, m, d, h int, sex string) {
	...
	you := g12.You
	xu := g12.Xu
	hais := pub.ArrStringToS(hai, "\n")
	zis := pub.ArrStringToS(zi, "\n")
	chous := pub.ArrStringToS(chou, "\n")
	yins := pub.ArrStringToS(yin, "\n")
	maos := pub.ArrStringToS(mao, "\n")
	chens := pub.ArrStringToS(chen, "\n")
	sis := pub.ArrStringToS(si, "\n")
	wus := pub.ArrStringToS(wu, "\n")
	weis := pub.ArrStringToS(wei, "\n")
	shens := pub.ArrStringToS(shen, "\n")
	yous := pub.ArrStringToS(you, "\n")
	xus := pub.ArrStringToS(xu, "\n")
	//
