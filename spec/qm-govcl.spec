...
cp -f %{_builddir}/%{name}-%{version}/%{name}/qm-govcl %{_buildrootdir}/%{name}-%{version}-%{release}.%{_arch}/usr/local/bin/qm-govcl
...
cp -f %{_builddir}/%{name}-%{version}/%{name}/qm-govcl.png %{_buildrootdir}/%{name}-%{version}-%{release}.%{_arch}/usr/local/share/icons/qm-govcl.png
cp -f %{_builddir}/%{name}-%{version}/%{name}/qm-govcl.desktop %{_buildrootdir}/%{name}-%{version}-%{release}.%{_arch}/usr/local/share/applications/qm-govcl.desktop
