...
mkdir -p %{_buildrootdir}/%{name}-%{version}-%{release}.%{_arch}/%{_datadir}/icons/ziwei/
...
install -m0755 %{_builddir}/%{name}-%{version}/ziwei.png %{_buildrootdir}/%{name}-%{version}-%{release}.%{_arch}/%{_datadir}/icons/ziwei/ziwei.png
...
%{_datadir}/icons/ziwei
%{_datadir}/icons/ziwei/ziwei.png
