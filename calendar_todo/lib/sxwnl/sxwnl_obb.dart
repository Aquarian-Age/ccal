...
//  #region 转换时增加的私有字段(用于封装成公共属性, 按转换规范 10 命名)
  ...
  // 十天干表
  static const List<String> Gan = ["甲", "乙", "丙", "丁", "戊", "己", "庚", "辛", "壬", "癸"];

  // 十二地支表
  static const List<String> Zhi = ["子", "丑", "寅", "卯", "辰", "巳", "午", "未", "申", "酉", "戌", "亥"];

  // 十二属相表
  static const List<String> ShX = ["鼠", "牛", "虎", "兔", "龙", "蛇", "马", "羊", "猴", "鸡", "狗", "猪"];

  // 十二星座表
  static const List<String> XiZ = ["摩羯", "水瓶", "双鱼", "白羊", "金牛", "双子", "巨蟹", "狮子", "处女", "天秤", "天蝎", "射手"];
  ...
  static const List<String> ymc = ["冬", "腊", "正", "二", "三", "四", "五", "六", "七", "八", "九", "十"]; //月名称,建寅
  ...
  // 日十二建表
  static const List<String> RiJian12 = ["建", "除", "满", "平", "定", "执", "破", "危", "成", "收", "开", "闭"];
  ...
  /// 二十八宿(日宿)
  static const List<String> starName = [
    //
